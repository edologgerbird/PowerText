...
format.align_text("The CSV file used for this demo can be downloaded from the link below:", "justify")
...
try:
    ...
    format.align_text("The feedback CSV file generated by the system can be downloaded from the link below:", "justify")
